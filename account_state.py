...
from contracts import RiskSnapshot, StrategySnapshot, Position, Account
...
class AccountState:
    ...
    def update(self):
        ...
        # 1. 更新持仓
        self.positions = {}
        for side, raw_pos in snapshot.positions.items():
    ...
    def get_strategy_snapshot(self, engine_name: str) -> StrategySnapshot:
        """
        为策略引擎提供其关心的数据视图。
